...
/**
 * @ngdoc directive
 * @name mud-theme.directive:menuToggle
 * @description
 * # menuToggle
 */
 angular
 ...
 .directive('menuToggle', ['$timeout', '$mdUtil', function($timeout, $mdUtil) {
    ...
    templateUrl: 'scripts/theme/components/menuToggle/menuToggle.html',
        ...
        $scope.$watch(
          ...
          function (open) {
            ...
            $mdUtil.nextTick(function() {
              ...
              var docsMenuContent = document.querySelector('.main-menu').parentNode;
